...
def draw_field():
    ...
    goals = [(37, 90), (34, 96), (34, 93), (37, 98),(38,92)] # Torpositionen 
    assists = [(68, 100), (16, 82), (39, 77), (27, 97),(51,99)]  # Assist-Positionen
    ...
    plt.title("Kalsdorf - Gegentore - 1 Elfmeter nicht berücksichtigt")
