...
def draw_field():
    ...
    # Tore (Fußball-Symbol) & Assists (dFS Treibach)
    goals = [(34,86),(34,87),(37,98)] # Torpositionen 
    assists = [(22,74),(66,82),(0,88)]  # Assist-Positionen
    ...
    plt.title("Voitsberg - Gegentore\n1Elfmeter und 1 dir. FS nicht berücksichtigt")
