...
def draw_field():
    ...
    goals = [(12,79),(41,97),(23,87),(31,96),(26,95),(42,97)]  # Torpositionen 
    assists = [(54,52),(38,83),(29,68),(19,98),(16,96),(60,26)]  # Assist-Positionen
    ...
    plt.title("Wallern - Tore - 1 Elfmeter nicht berücksichtigt")
