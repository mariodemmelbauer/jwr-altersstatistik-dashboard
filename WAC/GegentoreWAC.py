...
def draw_field():
    ...
    goals = [(34, 97),(32,99),(30,95),(35,93)] # Torpositionen 
    assists = [(29, 97),(0,100),(32,94),(18,95)]  # Assist-Positionen
    ...
    plt.title("WAC - Gegentore\n Elfmeter und drekter Freistoß nicht berücksichtigt")
