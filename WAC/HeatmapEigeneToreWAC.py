...
def draw_heatmap(ax, goals):
    ...
    if len(goals) < 3:
        ax.scatter(goal_positions[:,0], goal_positions[:,1], color="red", s=200, label="Tore", zorder=10)
        ax.legend()
    else:
...
goals = [(30, 93), (43, 77), (37, 84), (43, 89)]  # Torpositionen 
